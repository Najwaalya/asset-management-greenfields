...
@section('title', 'Buat Laporan Maintenance')
@section('page-title', 'Buat Laporan Maintenance')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow border border-gray-200 p-6">
        ...
        <h2 class="text-xl font-bold text-gray-900 mb-6">Buat Laporan Baru</h2>
        ...
        <form action="{{ route('maintenance.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="issue" rows="3"
                          ...
                          placeholder="Deskripsikan masalah yang terjadi..." required>{{ old('issue') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="solution" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                          placeholder="Isi jika sudah ada solusi...">{{ old('solution') }}</textarea>
            </div>
